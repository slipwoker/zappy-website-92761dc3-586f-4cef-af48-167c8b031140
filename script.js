    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (minLength && value.length < parseInt(minLength)) {
                showError(input, (isRTL ? 'يجب أن يكون على الأقل ' : 'Must be at least ') + minLength + (isRTL ? ' أحرف' : ' characters'));
                return false;
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    submitButton.textContent = document.documentElement.dir === 'rtl' ? 'جاري الإرسال...' : 'Sending...';
                }
                ...
                successMessage.style.cssText = 'background-color: #d4edda; color: #155724; padding: 1rem; border-radius: 0.25rem; margin-top: 1rem; text-align: center;';
                successMessage.textContent = document.documentElement.dir === 'rtl' ? 'تم إرسال رسالتك بنجاح!' : 'Your message has been sent successfully!';
                ...
                setTimeout(function() {
                    const msg = contactForm.querySelector('.form-success-message');
                    if (msg) msg.remove();
                }, 5000);
            }
        });
    ...
    if (animatedElements.length > 0) {
        ...
        animatedElements.forEach(function(element) {
            ...
            if (element.classList.contains('fade-in-up')) {
                ...
                element.style.transform = isRTL ? 'translateX(30px)' : 'translateX(-30px)';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '92761dc3-586f-4cef-af48-167c8b031140',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '92761dc3-586f-4cef-af48-167c8b031140';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '92761dc3-586f-4cef-af48-167c8b031140';
